...
category_urls <- category_urls[!(category_urls %in% c("/calzado/100",
                                                      "/calzado/100?filters=10070",
                                                      "/calzado/100?filters=1007100",                    
                                                      "https://moweek.com.uy/calzado/botas-y-botines/100"))]
...
write_rds(product_data, "data-raw/product_shoes.rds")
...
write_rds(product_data_clean, here("data-raw", "product_shoes_clean.rds"))
