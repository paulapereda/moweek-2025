...
category_urls <- category_urls[!(category_urls %in% c("/vestimenta/100", 
                                                      "/vestimenta/100?filters=20070", 
                                                      "/vestimenta/100?filters=2007200", 
                                                      "https://moweek.com.uy/vestimenta/pantalones/100"))]
...
write_rds(product_data, "data-raw/product_clothing.rds")
...
write_rds(product_data_clean, here("data-raw", "product_clothing.rds"))
