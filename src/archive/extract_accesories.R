...
category_urls <- category_urls[!(category_urls %in% c("/accesorios/100", 
                                                      "/accesorios/100?filters=10070",                                                       
                                                      "/accesorios/100?filters=1007100",                                                    
                                                      "https://moweek.com.uy/accesorios/100?category2=50&minPrice=$440&maxPrice=$100100.500"))]
...
write_rds(product_data, "data-raw/product_accesories.rds")
...
write_rds(product_data_clean, here("data-raw", "product_accesories_clean.rds"))
